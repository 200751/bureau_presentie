...
//prettyDump($_POST);
    if (isset($_POST['submit']) && $_POST['submit'] != '') {
        ...
        $query1 = $con->prepare("INSERT INTO admin_user (email) VALUES (AES_ENCRYPT(?,'{$_ENV['SALT']}'));");
        if ($query1 === false) {
        ...
        if ($query1->execute() === false) {
            ...
            $successarray[] = "Gebruiker toegevoegd";
        }
        $query1->close();
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Toevoegen Admin User</li>
          </ol>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-plain">
                <div class="card-body">
                <form role="form" enctype="multipart/form-data" method="post" action="add_user.php">
